                    ...
                    <div class="row align-items-center position-relative">
                        <div class="col-xl-3 col-lg-4">
                            <div class="movie-details-img">
                                <img src="img/poster/hanh-phuc-bi-danh-cap.jpg" alt="">
                                <a href="https://www.youtube.com/watch?v=HI2dWeOx2iM" class="popup-video"><img src="img/images/play_icon.png" alt=""></a>
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-8">
                            <div class="movie-details-content">
                                <h5>New Episodes</h5>
                                <h2>Hạnh Phúc<span> Bị </span>Đánh Cắp</h2>
                                ...
                                <p>Phim "Hạnh Phúc Bị Đánh Cắp" kể về cuộc đời của hai người phụ nữ Thúy Hạnh và Ánh Dương, khi họ vào làm dâu gia tộc họ Đỗ - nơi truyền thống nghề thêu tay. Con dâu trưởng Thúy Hạnh hiền lành, chịu khó và thông minh nhưng bị vướng vào hàm oan giết chồng, hãm hại cháu ruột. Ngược lại, con dâu thứ Ánh Dương tài năng nhưng đầy mưu mô, tham vọng, sẵn sàng hại người để đạt được mục đích. Cả hai cùng bị cuốn vào vòng xoáy tranh đấu để trở thành truyền nhân thêu của gia tộc, gây ra nhiều bi kịch cho những người họ yêu thương. Lan Hương, Hồng Ánh, Ngọc Lan cùng Nhâm Minh Hiền là những diễn viên chính trong bộ phim này.</p>
                    ...
                    <div class="row">
                                    ...
                                    <div class="accordion" id="accordionExample">
                                        <div class="card">
                                            ...
                                            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                                                <div class="card-body">
                                                    <ul>
                                                        <li><a href="https://www.youtube.com/watch?v=q4MviZPDOvk" class="popup-video"><i class="fas fa-play"></i> Tập 1 - The World Is Purple</a> <span class="duration"><i class="far fa-clock"></i> 33:47 Min</span></li>
                        ...
                        <div class="col-lg-4">
                            <div class="episode-img">
                                <img src="img/images/hanh-phuc-bi-danh-cap.jpg" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="row">
